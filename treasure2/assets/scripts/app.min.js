...
!(function () {
                ...
                (o =
                    "function" ==
                        typeof (i = function (t) {
                            ...
                            var n = (e.prototype = Object.create(
                                t.Item.prototype
                            )),
                                i = n._create;
                            (n._create = function () {
            ...
            !(function (e, n) {
                ...
                function (i, r) {
                        ...
                        for (e in ((n = at.support = {}),
                            ...
                            (at.attr = function (t, e) {
                                ...
                                var r = i.attrHandle[e.toLowerCase()],
                                    o =
                                        r &&
                                            k.call(i.attrHandle, e.toLowerCase())
                                            ? r(t, e, !m)
                                            : void 0;
                                return void 0 !== o
                                    ? o
                        ...
                        function Ct(t, e, n, i, r, o) {
                            return (
                                ...
                                lt(function (o, s, a, u) {
                                    ...
                                    } else (v = Tt(v === s ? v.splice(p, v.length) : v)), r ? r(null, s, v, u) : N.apply(s, v);
                                })
                            );
                        }
                        function St(t) {
                    ...
                    S.fn.extend({
                        ...
                        add: function (t, e) {
                            return this.pushStack(
                                S.uniqueSort(S.merge(this.get(), S(t, e)))
                            );
                        },
                        addBack: function (t) {
                            return this.add(
                    ...
                    (pt = x
                        ...
                        (mt = x.createElement("input")).setAttribute(
                            "type",
                            "radio"
                        ),
                        ...
                        (g.noCloneChecked = !!pt.cloneNode(!0).lastChild
                            .defaultValue),
                    ...
                    function At(t, e, n, i, r, o) {
                        ...
                        return (
                            ...
                            ((s = r),
                                ((r = function (t) {
                                    return (
                                        S().off(t), s.apply(this, arguments)
                                    );
                    ...
                    (S.event = {
                        ...
                        dispatch: function (t) {
                            ...
                            if (
                                ...
                                for (
                                    s = S.event.handlers.call(this, u, l),
                                    e = 0;
                                    (r = s[e++]) &&
                    ...
                    function Wt(t, e, n, i) {
                        ...
                        if (
                            d &&
                            ((o = (r = Ct(e, t[0].ownerDocument, !1, t, i))
                                .firstChild),
                                1 === r.childNodes.length && (r = o),
                                o || i)
                        ) {
                            for (
                                a = (s = S.map(bt(r, "script"), Ot)).length;
                                f < d;
                                f++
                            )
                                (l = r),
                    ...
                    function de(t, e, n) {
                        ...
                        for (
                            ...
                            if (
                                (i = de.prefilters[o].call(l, t, c, l.opts))
                            )
                                return (
                                    v(i.stop) &&
                                    (S._queueHooks(
                    ...
                    (S.Animation = S.extend(de, {
                        ...
                        prefilter: function (t, e) {
                            e
                                ? de.prefilters.unshift(t)
                                : de.prefilters.push(t);
                        },
                    })),
                    ...
                    S.parseXML = function (t) {
                        ...
                        try {
                            e = new i.DOMParser().parseFromString(
                                t,
                                "text/xml"
                            );
                        } catch (t) { }
                    ...
                    function De(t, e, n, i) {
                        ...
                        else for (r in e) De(t + "[" + r + "]", e[r], n, i);
                    }
                                ...
                                function E(t, e, s, u) {
                                    ...
                                    l ||
                                        ((l = !0),
                                            ...
                                            (C.statusText = (e || T) + ""),
                                            f
                                                ? g.resolveWith(p, [d, T, C])
                                                : g.rejectWith(p, [C, T, x]),
                                            C.statusCode(y),
                                            (y = void 0),
                                            c &&
                                            m.trigger(
                    ...
                    S.ajaxSetup({
                                ...
                                "static" === l &&
                                    ...
                                    ("absolute" === l || "fixed" === l) &&
                                        ...
                                        : ((s = parseFloat(o) || 0),
                                            (r = parseFloat(u) || 0)),
                                    v(e) &&
                                    (e = e.call(t, n, S.extend({}, a))),
                                    null != e.top &&
                                    (f.top = e.top - a.top + s),
                                    null != e.left &&
                                    (f.left = e.left - a.left + r),
                                    "using" in e
                                        ? e.using.call(t, f)
                                        : c.css(f);
                            },
                        ...
                        S.fn.extend({
                            ...
                            hover: function (t, e) {
                                return this.mouseenter(t).mouseleave(
                                    e || t
                                );
                            },
                        }),
                ...
                (o =
                    "function" ==
                        typeof (i = function (t, e) {
                            ...
                            var u = (a.prototype = Object.create(
                                t.prototype
                            ));
                            (u.constructor = a),
                                (u._create = function () {
                            ...
                            return (
                                ...
                                (u.getHideRevealTransitionEndProperty =
                                    function (t) {
                        ...
                        return (function (t, e, n, i, r) {
                            ...
                            i.extend(f, e.prototype),
                                ...
                                (f._getOption = function (t) {
                                    var e =
                                        this.constructor.compatOptions[
                                        t
                                        ];
                                    return e &&
                                ...
                                (f._filterFindItemElements = function (
                                    t
                                ) {
                                ...
                                (f._setContainerMeasure = function (
                                    t,
                                    e
                                ) {
                                    if (void 0 !== t) {
                                ...
                                (f._emitCompleteOnItems = function (
                                    t,
                                    e
                                ) {
                                    var n = this;
    ...
    (n.n = function (t) {
        ...
        (function () {
            ...
            function i() {
                ...
                "fixed" === e.css("position") &&
                    (e.css("position", "static"),
                        t("html, body").scrollTop(-parseInt(e.css("top"), 10)),
                        e.css({
                            position: "",
                            width: "",
                            height: "",
            ...
            var r = function () {
                var t = document.querySelector(".js-burger"),
                    n = document.querySelector(".js-nav");
                t.addEventListener("click", function (r) {
                    r.stopPropagation(),
                        [t, n].forEach(function (t) {
                            t.classList.toggle("is-active"),
                                t.classList.contains("is-active") ? e() : i();
                        });
                }),
                    document.addEventListener("click", function (e) {
                        ...
                        r === n ||
                            ...
                            [n, t].forEach(function (t) {
                                t.classList.remove("is-active"), i();
                            });
                    });
            };
            function o(t) {
            ...
            n(755)(function () {
                var t, n, s, a, c, d, h;
                r(),
                    (t = document.querySelectorAll("[data-open-modal]")),
                    (n = document.querySelectorAll(".js-modal")),
                    (s = document.querySelectorAll(".js-modal-close")),
                    (a = document.querySelectorAll(".js-modal-form-btn")),
                    (c = document.querySelectorAll(".js-button-skip-label")),
                    (h = [
                        (d = document.querySelector(".js-modals-overlay")),
                    ].coverlayzoncat(o(c), o(s), o(a))),
                    t.forEach(function (t) {
                        t.addEventListener("click", function (i) {
                            c.forEach(function (t) {
                                ...
                                n.forEach(function (n) {
                                    n.getAttribute("data-modal") ===
                                        t.getAttribute("data-open-modal") &&
                    ...
                    localStorage.getItem("story")
                        ? u()(".js-cookie").fadeOut()
                        : u()(".js-cookie").fadeIn(),
                    u()(".js-cookie-add").click(function () {
                        localStorage.setItem("story", "true"),
                            u()(".js-cookie").fadeOut();
                    }),
                    u()(".js-cookie-close").click(function () {
                        u()(".js-cookie").fadeOut();
                    }),
                    (function () {
                        var t = l(".header");
                        if (t.length) {
                            ...
                            n(), window.addEventListener("scroll", n, !1);
                        }
                    })(),
                    (function () {
                        var t = document.querySelectorAll(".js-games"),
                            n = document.querySelector('[data-modal="login"]'),
                            i = document.querySelector(".js-modals-overlay"),
                    ...
                    (function () {
                        var t = document.querySelector(".js-filter-area"),
                            e = document.querySelectorAll(".js-filter-btn");
                        if (t && e) {
                            var n = new (f())(t, {
                            ...
                            e.forEach(function (t) {
                                t.addEventListener("click", function () {
                                    e.forEach(function (t) {
                                        return t.classList.remove("is-checked");
                                    }),
